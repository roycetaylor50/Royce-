...
<body class="bg-gray-100 text-gray-900">
  ...
  <nav class="bg-white shadow p-4 flex justify-between items-center">
    <h1 class="text-2xl font-bold"><div class="flex items-center space-x-3">
      <div class="w-10 h-10 rounded-2xl bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center text-white font-bold text-lg shadow">RO</div>
  ...
  <section id="contact" class="py-20 px-6 text-center">
    ...
    <p class="text-gray-600 mb-2">Call or text us: (406) 596-1630</p>
